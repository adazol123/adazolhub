...
function Card( {title, content, icon}) {;
  ...
  return (
    <div className="card group  px-6 py-12 bg-gradient-to-bl from-[#293643] to-[#1D332C]/10 max-w-[28rem] relative space-y-2 rounded-md border border-transparent hover:border-green-300 max-h-max hover:bg-gradient-to-br transition-all shadow-lg">
